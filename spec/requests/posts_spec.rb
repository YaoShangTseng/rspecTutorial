...
RSpec.describe "posts", :type => :request do
  ...
  it "#index" do
    ...
    expect(response.body).to include("Title")                   # view的測試
    expect(response.body).to include("Content")                 # view的測試
    expect(response.body).to include("post from request spec")  # model的測試
  end
